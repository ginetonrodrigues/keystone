...
export const ClonarManualTokensDoc = () => {
  const t = useT();
  return (
    <DocPage>
      <PageHeader breadcrumb={t("navSectionClonar")} title={t("clonarTokensTitle")} description={t("clonarTokensDesc")} resources={false} />
      ...
      {section(t("clonarTokensReactTitle"), t("clonarTokensReactBody"))}
      {section(t("clonarTokensFlutterTitle"), t("clonarTokensFlutterBody"))}
