...
export const ClonarManualEstilosDoc = () => {
  const t = useT();
  return (
    <DocPage>
      <PageHeader breadcrumb={t("navSectionClonar")} title={t("clonarEstilosTitle")} description={t("clonarEstilosDesc")} resources={false} />
      ...
      {section(t("clonarEstilosReactTitle"), t("clonarEstilosReactBody"))}
      {section(t("clonarEstilosFlutterTitle"), t("clonarEstilosFlutterBody"))}
